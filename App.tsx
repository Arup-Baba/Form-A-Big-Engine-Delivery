...
import { Service, ServiceStatus, User, Settings, AppData, Subscriber } from './types';
import { IconEngine, IconSettings, IconUser, IconLogout } from './components/ui/Icon';
import SettingsModal from './components/SettingsModal';
import { PrintPreview } from './components/PrintPreview';
import LoginPage from './components/LoginPage';
import { UserManagementPage } from './components/admin/UserManagementPage';
import { SubscriberManagementPage } from './components/admin/SubscriberManagementPage';
...
type AppView = 'FORM' | 'LIST' | 'USER_MANAGEMENT' | 'SUBSCRIBER_MANAGEMENT';
...
const App: React.FC = () => {
  ...
  }, [submissions, users, settings, subscribers]);
  ...
  }, [submissions, users, settings, subscribers, getFullAppData]);
  ...
  const handleUpdateSubscribers = (allSubscribers: Subscriber[]) => {
            ...
            <div className="space-x-2">
              ...
              {currentUser.role === 'admin' && (
                <>
                  ...
                  <Button variant="secondary" onClick={() => setView('SUBSCRIBER_MANAGEMENT')} disabled={view === 'SUBSCRIBER_MANAGEMENT'}>
                    <IconUser className="w-5 h-5 mr-2" />
                    Subscribers
                  </Button>
                </>
